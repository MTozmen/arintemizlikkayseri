    ...
    <>
      ...
      <nav className={`mobile-nav ${menuOpen ? 'active' : ''}`}>
        ...
        <div style={{ display: 'flex', gap: '8px', marginTop: '16px' }}>
          <a href="tel:05332952038" className="btn-primary" style={{ flex: 1, padding: '12px 0', backgroundColor: '#25D366', borderColor: '#25D366', fontSize: '14px', margin: 0 }}>
            📞 BİZİ ARAYIN
          </a>
          <a href="tel:05332952038" className="btn-outline" style={{ flex: 1, padding: '12px 0', backgroundColor: 'var(--bg-alt)', fontSize: '14px', margin: 0 }}>
            0533 295 20 38
          </a>
        </div>
      ...
      <a href="https://instagram.com/arintemizlikkayseri" className="instagram-float" target="_blank" rel="noreferrer">
